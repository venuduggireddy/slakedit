...
Note right of Okta REST API: Creates new client,<br/>generates, client_id, secret<br/> and stores in <br/> keycloak database
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTYwNTQ0NzA1MiwxOTgyMTYxNjE5LDEyND
